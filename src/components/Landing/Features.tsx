    ...
    <section className="py-12 lg:py-20 border-b border-gray-100 last:border-b-0">
      <div className={`flex flex-col md:flex-row items-center gap-8 lg:gap-16`}>
        ...
        <div className={`w-full md:w-1/2 ${textOrderClass}`}>
          ...
          {/* <div className="mt-6">
            <a href="#demo" className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#0480e6] to-[#0066d6] px-4 py-2 text-sm font-semibold text-white shadow-md hover:scale-[1.02] transform transition">
              Request demo
            </a>
          </div> */}
        </div>
...
// const AlternatingFeature = ({ feature, index }) => {
